 ...
 */
final class Version20200410093732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE acteur_film ADD film_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE acteur_film ADD CONSTRAINT FK_14B01103567F5183 FOREIGN KEY (film_id) REFERENCES film (id)');
        $this->addSql('CREATE INDEX IDX_14B01103567F5183 ON acteur_film (film_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_14B01103567F5183 ON acteur_film');
        $this->addSql('ALTER TABLE acteur_film DROP film_id');
